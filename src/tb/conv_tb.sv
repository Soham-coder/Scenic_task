...
//Input: 1 x  1 x  360 x 1 | Filter: 1 x 1 x 3 x 128 | Output: 1 x  1 x  358 x 128 | Stride: 1 | Total clk cyclsim: 65536
...
module conv_tb_v2();
    ...
    parameter filt_w = 1;
    parameter filt_c = 1;
    parameter num_filt = 128;

    parameter stride = 1;

    parameter out_h = ((actn_h - filt_h)/stride)+1;//358
    parameter out_w = ((actn_w - filt_w)/stride)+1;//1
